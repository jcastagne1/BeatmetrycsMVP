...
CLIENT_SECRETS_FILE = "ClientAuth.json"
...
app.secret_key = "IpKyBrGMKjQ2uu4mILl8"
...
def test_api_request():
    ...
    bucket = client.bucket("saas-373604.appspot.com")
    blob = bucket.get_blob("credentials.json")
    ...
    report = youtube.reports().query(ids='channel==MINE', 
    ...
    blob.upload_from_string(credentials_json)
...
def authorize():
    ...
    # error.
    flow.redirect_uri = "https://saas-373604.rj.r.appspot.com/oauth2/callback"
...
def oauth2callback():
    ...
    # Store the credentials in cloud storage
